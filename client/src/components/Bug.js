  ...
  return (
    <div>
      <button
        ...
        className="flex flex-row items-center justify-between px-4 py-5 w-full bg-white hover:bg-gray-800-alpha-30 transition-colors duration-500 ease-in-out dark:bg-gray-900 focus:outline-none border border-purple-a400 rounded-lg"
      >
      ...
      >
        {isMounted ? (
          <div className="flex flex-wrap w-full max-w-screen bg-gray-50 dark:bg-gray-900 border-l border-r rounded-lg p-4">
